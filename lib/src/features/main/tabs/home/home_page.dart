...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
                ...
                child: LazyLoadScrollView(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) => index ==
                        ...
                        : buildPlacesItem(context, state.places[index], index),
                  ),
                ),
              ),
              Padding(
              ...
              SizedBox(
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return buildTechnologyItem(
                          context, state.technologies?[index], index);
                    }),
              ),
            ],
          ),
  ...
  Widget buildPlacesItem(BuildContext context, PlaceModel? model, int index) {
    return AppContainer(
      padding: const EdgeInsets.all(8),
      onTab: () {
        context.pushNamed(AppRoutes.placeDetails.name,
